...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { bio: @instructor.bio, email: @instructor.email, img: @instructor.img, linkedin: @instructor.linkedin, name: @instructor.name, title: @instructor.title } }, as: :json
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { bio: @instructor.bio, email: @instructor.email, img: @instructor.img, linkedin: @instructor.linkedin, name: @instructor.name, title: @instructor.title } }, as: :json
    assert_response 200
  end
